...
// import { JsSignatureProvider } from 'plasmajs/dist/plasmajs-jssig';

const rpc = new JsonRpc(''); // nodeos and web server are on same port
const JsSignatureProvider = require('plasmajs/dist/plasmajs-jssig').default;
...
class PostForm extends React.Component<{}, PostFormState> {
    ...
    constructor(props: {}) {
        ...
        this.state = {
            privateKey: '5JRebynXs1emAgt4Cbm7HRmGsjGrLzdGCwM7oXZXeKtTqn9pspB',
            data: {
                id: 0,
                user: 'bob',
                reply_to: 0,
